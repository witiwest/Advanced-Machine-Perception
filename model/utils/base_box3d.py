...
import importlib
from .box3d_utils import limit_period, xywhr2xyxyr

def load_ext(name, funcs):
    ext_module = importlib.import_module('cpp_pkgs.' + name)
    for func in funcs:
        assert hasattr(ext_module, func), f'{func} miss in module {name}'
    return ext_module

ext_module = load_ext(
    '_ext', ['boxes_overlap_bev_gpu'])
...
class BaseInstance3DBoxes(object):
    ...
    def overlaps(cls, boxes1, boxes2, mode='iou'):
        ...
        ext_module.boxes_overlap_bev_gpu(boxes1_bev.contiguous().cuda(),
