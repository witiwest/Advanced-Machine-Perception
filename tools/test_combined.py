...
from common_src.model.detector import CenterPointCombined
from common_src.dataset import ViewOfDelft, collate_vod_batch


@hydra.main(version_base=None, config_path="../config", config_name="test_combined")
def eval(cfg: DictConfig) -> None:
    ...
    model = CenterPointCombined.load_from_checkpoint(
